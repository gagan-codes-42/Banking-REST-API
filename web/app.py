...
class Register(Resource):
    ...
    def verifyCredentials(username, password):
        if not UserExist(username):
            return generateReturnDictionary(301,"Invalid Usernames"), True
        
        correct_pw = verifyPw(username,password)

        if not correct_pw:
            return generateReturnDictionary(302,"Incorrect Pssword"), True
...
class Transfer(Resource):
    def post(self):
        ...
        cash = cashWithUser(username)
        if cash<=0:
            return jsonify(generateReturnDictionary(304,"You're out of money, please add or take money"))
...
class TakeLoan(Resource):
    def post(self):
        ...
        updateAccount(username,cash+money)
        updateDoubt(username,debt+money)
...
class PayLoan(Resource):
    def post(self):
        ...
        return jsonify(generateReturnDictionary(200,"You've successfully paid yoru loan"))
